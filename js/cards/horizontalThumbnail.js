Vue.component('horizontalthumbnail',{
  template: `
    <div class="bg-gray-100 dark:bg-gray-900">
      <div class="py-6 dark:bg-gray-800">
        ...
        <div class="flex pb-4 pl-4 space-x-2 overflow-x-auto">
          <horizontalthumbnailbase v-for='(post, index) in items' :key='index' :post="post"></horizontalthumbnailbase>
