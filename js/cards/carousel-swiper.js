Vue.component('carousel-swiper', {
  template: `
  <div class='py-6 bg-white dark:bg-gray-900 section-border-bottom'>
    <h2 class="px-4 mb-4 text-lg font-medium text-zaobao-500 dark:text-zaobao-950">精选新闻</h2>
    <div class='swiper' v-swiper:swiper='swiperOptions' @click-slide='onSwiperClickSlide' @slide-change-transition-start='onSwiperSlideChangeTransitionStart'>
      <div class="swiper-pagination swiper-pagination-bullets"></div>
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="(post, index) in items" :key="index">
            ...
            <div class="py-4" style="height: 138px;">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                  ...
                  <a href='#' ><img class="w-3 ml-4 mr-2" src="./assets/images/share_ios.png" alt="" /></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class='px-4 pt-4 text-center text-zaobao-500 dark:text-zaobao-950'>
