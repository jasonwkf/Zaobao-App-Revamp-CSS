Vue.component('featured',{
  template: `
  <div class="mx-4 border-b border-gray-200 dark:border-gray-600">
    <!-- single image start -->
    <div class="aspect-w-8 aspect-h-5 -mx-4 relative" v-if="post.articleData.images.length < 2">
    ...
    <div class="py-3">
      ...
      <h3 class="h-10 mb-4 leading-tight clamp-2 dark:text-white text-gray-800">{{post.articleData.headline}}</h3>
